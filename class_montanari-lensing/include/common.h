...
struct precision
{
  ...
  /** TODO Can this parameter be replaced by smallest_allowed_variation ?
      Controls (computer dependent) rounding errors in interpolation with Gaussian window function. */
  double selection_rounding_tolerance;
