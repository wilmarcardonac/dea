...
#####################
OBJ   = fiducial.o background.o initial_conditions.o perturbations.o diff_asde.o radau5.o decsol.o dc_decsol.o 
...
diff_asde.o :	diff_asde.f90 fiducial.o background.o initial_conditions.o perturbations.o   
